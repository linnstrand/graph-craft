...
import { type Data, type GraphParams, sortByHeight } from "./util";
    ...
    <>
      <div className="settings">
        <button
          ...
          onClick={() =>
            layout?.cluster ? setTreeLayoutCluster() : setTreeLayout()
          }
        >
          layout Tree
        </button>
        ...
        <button
          ...
          onClick={() =>
            layout?.cluster ? setRadialCluster() : setRadialLayout()
          }
        >
          layout Radial
        </button>
